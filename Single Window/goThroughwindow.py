...
if clientID!=-1:
    ...
    # tryConfig1 = [0.9226,   -2.3992,   -1.7141,    0.9717,    0.700,   -2.4192] 
    tryConfig1 = [-1.0110,  -1.1291,    0.7916,    0.3375,    2.1395,    0.7224]

    tryConfig2 = [-1.1110,  -0.8291,    0.4916,    -1.57,    0.0,    0.7224]

    tryConfig3 = [-1.400,  -1.100,    0.491,    -1.270,    1.570,    0.811]

    tryConfigS_1 = [-1.0110,  -0.9291,    0.5916,    0.3375,    2.1395,    0.7224]
    tryConfigS_2 = [-1.0110,  -0.9291,    0.5916,    0.3375,    0.5000,    -0.7000]


    tryConfig = [-1.400,  -1.100,    1.1,    -0.0,    1.57,    2.0]
    ...
    inFloats = robotInitialState+ tryConfigS_2
